...
#          termrate = ifelse(age > 55, termrate[age == 55], termrate),
...
#          retrate = ifelse(age < 40, 0, retrate),
#          retrate = ifelse(age > 65, retrate[age == 65], retrate)) %>%
#   
#   ungroup %>%
#   splong("yos", 0:54) %>%
#   group_by(age) %>%
#   mutate(retrate = ifelse(yos < 20, retrate[yos == 20], retrate),
#          retrate = ifelse(yos > 26, retrate[yos == 26], retrate),
...
DisbRatesSched <-
  ...
  mutate(  disbrate = ifelse(age < 25, disbrate[age == 25], disbrate),
           disbrate = ifelse(age > 70, disbrate[age == 70], disbrate),
           planname      = planname,
           plantype      = plantype,
