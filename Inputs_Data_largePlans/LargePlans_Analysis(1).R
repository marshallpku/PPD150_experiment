...
largePlans_actives <- dataList_allPlans2$ActivesSched %>%
...
largePlans_actives_scales <- bind_rows(largePlans_actives_scales1,
                                       largePlans_actives_scales2)

largePlans_actives_scales

# Compare with scales in NMR papers. 
...
# Compute scales by plan
largePlans_retirees_scalesByPlan <- dataList_allPlans2$RetireeSched %>%
...
largePlans_retirees_scales <- bind_rows(largePlans_retirees_scales1,
                                       largePlans_retirees_scales2)
...
largePlans_actives_scales %>% head
...
largePlans_retirees_scales %>% head
...
write.xlsx(nactives_scales.spread$allTypes, file = "./Inputs_largePlans_raw/NMR_Comparison_raw.xlsx", sheetName = "nactives_allTypes", row.names = FALSE)
write.xlsx(nactives_scales.spread$general,  file = "./Inputs_largePlans_raw/NMR_Comparison_raw.xlsx", sheetName = "nactives_general" , row.names = FALSE, append = TRUE)
write.xlsx(nactives_scales.spread$safety,   file = "./Inputs_largePlans_raw/NMR_Comparison_raw.xlsx", sheetName = "nactives_safety"  , row.names = FALSE, append = TRUE)
write.xlsx(nactives_scales.spread$teacher,  file = "./Inputs_largePlans_raw/NMR_Comparison_raw.xlsx", sheetName = "nactives_teacher" , row.names = FALSE, append = TRUE)

write.xlsx(salary_scales.spread$allTypes,  file = "./Inputs_largePlans_raw/NMR_Comparison_raw.xlsx", sheetName = "salary_allTypes", row.names = FALSE, append = TRUE)
write.xlsx(salary_scales.spread$general,   file = "./Inputs_largePlans_raw/NMR_Comparison_raw.xlsx", sheetName = "salary_general" , row.names = FALSE, append = TRUE)
write.xlsx(salary_scales.spread$safety,    file = "./Inputs_largePlans_raw/NMR_Comparison_raw.xlsx", sheetName = "salary_safety"  , row.names = FALSE, append = TRUE)
write.xlsx(salary_scales.spread$teacher,   file = "./Inputs_largePlans_raw/NMR_Comparison_raw.xlsx", sheetName = "salary_teacher" , row.names = FALSE, append = TRUE)

write.xlsx(largePlans_retirees_scales.grp, file = "./Inputs_largePlans_raw/NMR_Comparison_raw.xlsx", sheetName = "retirees" , row.names = FALSE, append = TRUE)

write.xlsx(largePlans_salaryScale.grp, file = "./Inputs_largePlans_raw/NMR_Comparison_raw.xlsx", sheetName = "salaryScale" , row.names = FALSE, append = TRUE)

write.xlsx(largePlans_sep.grp, file = "./Inputs_largePlans_raw/NMR_Comparison_raw.xlsx", sheetName = "separation" , row.names = FALSE, append = TRUE)
...
# Final outputs
largePlans_singleValues_num
largePlans_singleValues_chr
